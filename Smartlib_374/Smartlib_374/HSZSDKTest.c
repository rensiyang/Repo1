...
#define DEVID_RSY " 00124B001602CF95"
//#define DEVID_XU "00124B0016027B08" 00124B0014655AC1 00124B00146579EF 00124B001477A621  00124B0018C339FE 374：00124B001602CF95
//SL500锁00124B0014655AC1
		...
		{ 
			...
			*/
				...
				//00124B00146579EF
						...
						case 'A':													 //RSY 374门锁 无线密码验证开锁
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100D31");								//11:标记位+密码验证 2：密码开锁 06：密码长度 123456：密码
						...
						case 'C':	//门锁时间同步														 
						{
								...
								char cmd[30] = {0};
								strcpy(cmd,"100D121905161200");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);  
//								strcpy(cmd,"100D43000119050714431905102200");								
								//HSZCommandsActiveReturn(DEVID_RSY,cmd);      
						}
						break;
						...
						case 'D':												 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100D380005");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd); 
//								strcpy(cmd,"100D44000119050714431905102200");								
								//HSZCommandsActiveReturn(DEVID_RSY,cmd);       
						}
						break;
						...
						case 'F':	//无线添加临时密码用户 												 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100D39000519051612051905161210");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case 'G':	//无线添加临时密码用户												 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100D39000599999999999999999999");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '-':	//无线删除临时密码用户												 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless delete tempature password user.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C2220064");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case 'K':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100D210612345619051315151905302020");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case 'L':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100D2117765432119051315151905302020");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case 'M':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100D212623456719051315151905302020");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case 'X':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25010023ACBDBBDDEE021046299B034076947E");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case 'Z':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25010008CCEEAAFFDD021041199B034076947E");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case 'l':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25000011ABCDEABCDE021041199B034076947E");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;

						//测试锁上报网关命令
						case 'm':			//n设置为恢复出厂设置，后续跳过n										 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								printf("RSY HSZCommandsActiveReturn.\n");
								strcpy(cmd,"Fa0B1451ffffffff20FFFFFFFF82");								
								HSZAnalysisSelfProtocolSL500LockData(cmd,AppGatewayMac(),DEVID_RSY);
						}
						break;
						...
						case '1':			//临时用户										 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25000001AABBCCDDEE0006222333");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '2':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25000002ABCDEABCDE00072223334");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '3':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25000003AACCBBDDEE021041199B034076947E");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '4':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25000004AADDCCBBEE021040199B034076947E");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '5':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C21206444666619032910001903292200");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '6':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C2120655577719032909001903292200");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '7':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25010004AAEEBBCCDD00072223335");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '8':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25010005AACCDDBBEE0006222333");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '9':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25010006CCBBAAEEDD0006223344");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '0':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C25010007BBCCAAEEDD021041199B034076947E");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case ',':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C2161043199B034076947E19032910001903292200");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
						...
						case '.':													 
						{
								DEBUG_APP_ZONE(LOG_APP_TEST,"Wireless password open door.\n");
								char cmd[30] = {0};
								strcpy(cmd,"100C2161044199B034076947E19032909001903292200");								
								HSZCommandsSend(AppGatewayMac(),DEVID_RSY,cmd);       
						}
						break;
